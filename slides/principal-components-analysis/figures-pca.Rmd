...
plot(z,asp=1,xlab="X", ylab="Y", pch=16, xlim=c(-5,5),ylim=c(-5,5),main=main.txt)
...
drawvectors.PC <- function(x,y){
    ...
    arrows(0, 0, newx[1],newx[2],col='steelblue',lwd=3, angle=15, length=0.15)
    text(newx[1],newx[2],"x", pos=4, offset=0.1,col='steelblue')
    
    arrows(0, 0, newy[1],newy[2],col='firebrick',lwd=3, angle=15, length=0.15)
    text(newy[1],newy[2],"y", pos=4, offset=0.1,col='firebrick')
    
    arrows(0, 0, p$proj[1], p$proj[2], lty='solid',lwd=3, angle=15, length=0.15)
    text(p$proj[1],p$proj[2],"Px", pos=4, offset=0.1)
    
    arrows(0, 0, newz[1], newz[2],col='forestgreen',lwd=3, angle=15, length=0.15)
    text(newz[1],newz[2],"PC1", pos=4, offset=0.1,col='forestgreen')    
 
    arrows(0, 0, newz2[1],newz2[2],col='forestgreen',lwd=3, angle=15, length=0.15)
    text(newz2[1],newz2[2],"PC2", pos=4, offset=0.1,col='forestgreen')
